...
//import net.marelias.notepad.format.asciidoc.AsciidocActionButtons;
//import net.marelias.notepad.format.asciidoc.AsciidocSyntaxHighlighter;
//import net.marelias.notepad.format.asciidoc.AsciidocTextConverter;
//import net.marelias.notepad.format.binary.EmbedBinaryTextConverter;
//import net.marelias.notepad.format.csv.CsvSyntaxHighlighter;
//import net.marelias.notepad.format.csv.CsvTextConverter;
//import net.marelias.notepad.format.keyvalue.KeyValueSyntaxHighlighter;
...
//import net.marelias.notepad.format.orgmode.OrgmodeActionButtons;
//import net.marelias.notepad.format.orgmode.OrgmodeSyntaxHighlighter;
//import net.marelias.notepad.format.orgmode.OrgmodeTextConverter;
//import net.marelias.notepad.format.plaintext.PlaintextActionButtons;
...
//import net.marelias.notepad.format.todotxt.TodoTxtActionButtons;
//import net.marelias.notepad.format.todotxt.TodoTxtAutoTextFormatter;
//import net.marelias.notepad.format.todotxt.TodoTxtSyntaxHighlighter;
//import net.marelias.notepad.format.todotxt.TodoTxtTextConverter;
//import net.marelias.notepad.format.wikitext.WikitextActionButtons;
//import net.marelias.notepad.format.wikitext.WikitextReplacePatternGenerator;
//import net.marelias.notepad.format.wikitext.WikitextSyntaxHighlighter;
//import net.marelias.notepad.format.wikitext.WikitextTextConverter;
